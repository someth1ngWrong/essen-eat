...
ActiveRecord::Schema.define(version: 2020_12_21_205607) do
  ...
  create_table "like_defs", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_id"], name: "index_like_defs_on_post_id"
    t.index ["user_id"], name: "index_like_defs_on_user_id"
  end
  ...
  create_table "tasties", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_id"], name: "index_tasties_on_post_id"
  ...
  create_table "yummies", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_id"], name: "index_yummies_on_post_id"
